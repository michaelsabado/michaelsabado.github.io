...
const U = {},
  ...
  Bn = (e) => (G(e) || O(e)) && O(e.then) && O(e.catch),
  Vn = Object.prototype.toString,
  ts = (e) => Vn.call(e),
  Qr = (e) => ts(e).slice(8, -1),
  Un = (e) => ts(e) === '[object Object]',
  Us = (e) => X(e) && e !== 'NaN' && e[0] !== '-' && '' + parseInt(e, 10) === e,
  vt = Ns(
  ...
  Zr = /\B([A-Z])/g,
  nt = ss((e) => e.replace(Zr, '-$1').toLowerCase()),
...
const Jn = (e) => !!(e && e.__v_isRef === !0),
  j = (e) =>
    X(e)
      ...
      : e == null
        ? ''
        : I(e) || (G(e) && (e.toString === Vn || !O(e.toString)))
          ? Jn(e)
            ? j(e.value)
...
function rt(e) {
  const t = N(e)
  return t === e ? t : (se(t, 'iterate', Et), be(e) ? t : t.map(ye))
}
function is(e) {
  return (se((e = N(e)), 'iterate', Et), e)
}
function Be(e, t) {
  return Fe(e) ? ft(st(e) ? ye(t) : t) : ye(t)
}
const fi = {
  __proto__: null,
  [Symbol.iterator]() {
  ...
  concat(...e) {
    return rt(this).concat(...e.map((t) => (I(t) ? rt(t) : t)))
  },
  entries() {
  ...
  filter(e, t) {
    return Me(this, 'filter', e, t, (s) => s.map((n) => Be(this, n)), arguments)
  },
  find(e, t) {
    return Me(this, 'find', e, t, (s) => Be(this, s), arguments)
  },
  findIndex(e, t) {
    return Me(this, 'findIndex', e, t, void 0, arguments)
  },
  findLast(e, t) {
    return Me(this, 'findLast', e, t, (s) => Be(this, s), arguments)
  },
  findLastIndex(e, t) {
...
function bs(e, t, s) {
  ...
  se(n, 'iterate', Et)
  const r = n[t](...s)
  return (r === -1 || r === !1) && Zs(s[0]) ? ((s[0] = N(s[0])), n[t](...s)) : r
}
function xt(e, t, s = []) {
  ;(Re(), Ks())
...
class ir extends rr {
  ...
  set(t, s, n, r) {
    ...
    if (!this._isShallow) {
      const h = Fe(i)
      if ((!be(n) && !Fe(n) && ((i = N(i)), (n = N(n))), !l && ne(i) && !ne(n)))
  ...
  ownKeys(t) {
    return (se(t, 'iterate', I(t) ? 'length' : tt), Reflect.ownKeys(t))
  }
}
class hi extends rr {
  constructor(t = !1) {
...
function Qs(e) {
  return Fe(e) ? e : Ys(e, !1, gi, yi, lr)
}
function Ti(e) {
  return Ys(e, !1, xi, vi, or)
}
function Es(e) {
...
function st(e) {
  return Fe(e) ? st(e.__v_raw) : !!(e && e.__v_isReactive)
}
function Fe(e) {
...
class Pi {
  ...
  set value(t) {
    const s = this._rawValue,
      n = this.__v_isShallow || be(t) || Fe(t)
    ;((t = n ? t : N(t)),
      We(t, s) &&
        ((this._rawValue = t), (this._value = n ? t : ye(t)), this.dep.trigger()))
  }
}
function L(e) {
...
function Ii(e, t, s = !1) {
  let n, r
  return (O(e) ? (n = e) : ((n = e.get), (r = e.set)), new Mi(n, r, s))
}
const Ut = {},
  Jt = new WeakMap()
let et
...
function ji(e, t, s = U) {
  ...
  let J = F ? new Array(e.length).fill(Ut) : Ut
  const Z = (E) => {
    if (!(!(u.flags & 1) || (!u.dirty && !E)))
      if (t) {
        const ee = u.run()
        if (r || R || (F ? ee.some((Le, ve) => We(Le, J[ve])) : We(ee, J))) {
          S && S()
          const Le = et
          et = u
          try {
            const ve = [ee, J === Ut ? void 0 : F && J[0] === Ut ? [] : J, C]
            ;((J = ee), c ? c(t, 3, ve) : t(...ve))
          } finally {
            et = Le
          }
        }
  ...
  return (
    ...
    t ? (n ? Z(!0) : (J = u.run())) : l ? l(Z.bind(null, !0), !0) : u.run(),
...
function je(e, t = 1 / 0, s) {
  if (t <= 0 || !G(e) || e.__v_skip || ((s = s || new Map()), (s.get(e) || 0) >= t))
    return e
  if ((s.set(e, t), t--, ne(e))) je(e.value, t, s)
  else if (I(e)) for (let n = 0; n < e.length; n++) je(e[n], t, s)
  else if (Nn(e) || ot(e))
    e.forEach((n) => {
      je(n, t, s)
    })
...
function Xs(e) {
  if (!(e.flags & 1)) {
    const t = Mt(e),
      s = ae[ae.length - 1]
    ;(!s || (!(e.flags & 2) && t >= Mt(s)) ? ae.push(e) : ae.splice(Fi(t), 0, e),
      (e.flags |= 1),
      dr())
  }
}
...
function pr(e) {
  if (at.length) {
    const t = [...new Set(at)].sort((s, n) => Mt(s) - Mt(n))
    if (((at.length = 0), Ve)) {
      Ve.push(...t)
      return
    }
...
function zt(e) {
  const t = xe
  return ((xe = e), (gr = (e && e.type.__scopeId) || null), t)
}
function Li(e, t = xe, s) {
  if (!t || e._n) return e
  const n = (...r) => {
    n._d && Sn(-1)
    const i = zt(t)
...
function Wt(e, t, s = !1) {
  ...
  if (n || ct) {
    ...
    if (arguments.length > 1) return s && O(t) ? t.call(n && n.proxy) : t
  }
}
...
function Wi(e, t, s) {
  const n = this.proxy,
    r = X(e) ? (e.includes('.') ? xr(n, e) : () => n[e]) : e.bind(n, n)
  let i
  O(t) ? (i = t) : ((i = t.handler), (s = t))
  const l = Rt(this),
    o = mr(r, i.bind(n), s)
  return (l(), o)
}
...
function St(e, t, s, n, r = !1) {
  if (I(e)) {
    e.forEach((R, F) => St(R, t && (I(t) ? t[F] : t), s, n, r))
    return
  }
  if (Ct(n) && !r) {
    n.shapeFlag & 512 &&
  ...
  const i = n.shapeFlag & 4 ? fs(n.component) : n.el,
    ...
    C = g === U ? Ln : (R) => B(S, R)
  if (h != null && h !== c) {
    if ((gn(t), X(h))) ((u[h] = null), C(h) && (g[h] = null))
    else if (ne(h)) {
      h.value = null
      const R = t
      R.k && (u[R.k] = null)
  ...
  if (O(c)) jt(c, o, 12, [l, u])
    ...
    if (R || F) {
      const ie = () => {
        if (e.f) {
          const D = R ? (C(c) ? g[c] : u[c]) : c.value
          if (r) I(D) && Vs(D, i)
          else if (I(D)) D.includes(i) || D.push(i)
          ...
          R ? ((u[c] = l), C(c) && (g[c] = l)) : F && ((c.value = l), e.k && (u[e.k] = l))
      }
      if (l) {
        const D = () => {
          ;(ie(), Qt.delete(e))
        }
        ;((D.id = -1), Qt.set(e, D), he(D, s))
      } else (gn(e), ie())
    }
  }
}
...
function ge(e, t, s, n) {
  ...
  if (l || X(e)) {
    ...
    let c = !1,
      h = !1
    ;(o && ((c = !be(e)), (h = Fe(e)), (e = is(e))), (r = new Array(e.length)))
    for (let u = 0, g = e.length; u < g; u++)
      r[u] = t(c ? (h ? ft(ye(e[u])) : ye(e[u])) : e[u], u, void 0, i)
...
const Ms = (e) => (e ? (Vr(e) ? fs(e) : Ms(e.parent)) : null),
  ...
  ys = (e, t) => e !== U && !e.__isScriptSetup && B(e, t),
  ol = {
    get({ _: e }, t) {
...
function al(e) {
  ...
  if (((Is = !0), i))
    for (const z in i) {
      const W = i[z],
        Qe = O(W) ? W.bind(s, s) : O(W.get) ? W.get.bind(s, s) : Pe,
        Lt = !O(W) && O(W.set) ? W.set.bind(s) : Pe,
        Ye = Ke({ get: Qe, set: Lt })
  ...
  if (o) for (const z in o) wr(o[z], n, s, z)
  if (c) {
    const z = O(c) ? c.call(s) : c
  ...
  u && xn(u, e, 'c')
  function le(z, W) {
    I(W) ? W.forEach((Qe) => z(Qe.bind(s))) : W && z(W.bind(s))
  }
  if (
    (le(Yi, g),
    le(Zi, S),
...
function xn(e, t, s) {
  Ee(I(e) ? e.map((n) => n.bind(t.proxy)) : e.bind(t.proxy), t, s)
}
function wr(e, t, s, n) {
  ...
  if (X(e)) {
    const i = t[e]
    O(i) && _s(r, i)
  } else if (O(e)) _s(r, e.bind(s))
  else if (G(e))
    if (I(e)) e.forEach((i) => wr(i, t, s, n))
    else {
      const i = O(e.handler) ? e.handler.bind(s) : t[e.handler]
      O(i) && _s(r, i, e)
    }
}
function kr(e) {
...
function bn(e, t) {
  return t
    ? e
      ? function () {
          return re(O(e) ? e.call(this, this) : e, O(t) ? t.call(this, this) : t)
        }
      : t
    : e
}
...
function ml(e, t, ...s) {
  ...
  const i = t.startsWith('update:'),
    l = i && gl(n, t.slice(7))
  l && (l.trim && (r = s.map((u) => (X(u) ? u.trim() : u))), l.number && (r = s.map(Xr)))
  let o,
...
function Cr(e, t, s = !1) {
  ...
  return !i && !o
    ...
    : (I(i) ? i.forEach((c) => (l[c] = null)) : re(l, i), G(e) && n.set(e, l), l)
}
function as(e, t) {
  return !e || !es(t)
    ? !1
...
function yn(e) {
  ...
  try {
    if (s.shapeFlag & 4) {
      const E = r || n,
        ee = E
      ;((D = $e(h.call(ee, E, u, g, C, S, R))), (J = o))
    } else {
      const E = t
      ;((D = $e(E.length > 1 ? E(g, { attrs: o, slots: l, emit: c }) : E(g, null))),
        (J = t.props ? o : bl(o)))
    }
  } catch (E) {
    ;((At.length = 0), ls(E, e, 1), (D = te(Je)))
  }
  let Z = D
  if (J && F !== !1) {
    const E = Object.keys(J),
      { shapeFlag: ee } = Z
    E.length && ee & 7 && (i && E.some(Bs) && (J = _l(J, i)), (Z = ut(Z, J, !1, !0)))
  }
  return (
    s.dirs &&
      ((Z = ut(Z, null, !1, !0)), (Z.dirs = Z.dirs ? Z.dirs.concat(s.dirs) : s.dirs)),
    s.transition && en(Z, s.transition),
    (D = Z),
    zt(ie),
    D
  )
...
function js(e, t, s, n, r, i) {
  ...
  if (l != null) {
    ...
    if (o && n === void 0) {
      const c = l.default
      if (l.type !== Function && !l.skipFactory && O(c)) {
...
function Er(e, t, s = !1) {
  ...
  if (!i && !c) return (G(e) && n.set(e, lt), lt)
  if (I(i))
    for (let u = 0; u < i.length; u++) {
      const g = qe(i[u])
      wn(g) && (l[g] = U)
    ...
    for (const u in i) {
      ...
      if (wn(g)) {
        ...
        else F = O(R) && R.name === 'Boolean'
        ;((C[0] = F), (C[1] = ie), (F || B(C, 'default')) && o.push(g))
      }
    }
  const h = [l, o]
...
const tn = (e) => e === '_' || e === '_ctx' || e === '$stable',
  sn = (e) => (I(e) ? e.map($e) : [$e(e)]),
  Cl = (e, t, s) => {
    if (t._n) return t
    const n = Li((...r) => sn(t(...r)), s)
    return ((n._c = !1), n)
  },
  Mr = (e, t, s) => {
    const n = e._ctx
  ...
  Tl = (e, t, s) => {
    ...
    if (e.vnode.shapeFlag & 32) {
      const r = t._
      r ? (Or(n, t, s), s && Kn(n, '_', r, !0)) : Mr(t, n)
    } else t && Ir(e, t)
  },
  Al = (e, t, s) => {
    ...
    if (n.shapeFlag & 32) {
      const o = t._
      ;(o ? (s && o === 1 ? (i = !1) : Or(r, t, s)) : ((i = !t.$stable), Mr(t, r)),
        (l = t))
...
function Pl(e, t) {
  ...
  const {
    ...
    F = (
      ...
      if (a === f) return
      ;(a && !bt(a, f) && ((_ = Nt(a)), we(a, m, x, !0), (a = null)),
        f.patchFlag === -2 && ((y = !1), (f.dynamicChildren = null)))
      const { type: b, ref: $, shapeFlag: k } = f
      switch (b) {
        case cs:
          ie(a, f, p, _)
          break
        ...
        case ws:
          ...
          break
        case Y:
          Ft(a, f, p, _, m, x, w, v, y)
          break
        default:
          k & 1
            ? ee(a, f, p, _, m, x, w, v, y)
            : k & 6
              ? Dt(a, f, p, _, m, x, w, v, y)
              : (k & 64 || k & 128) && b.process(a, f, p, _, m, x, w, v, y, gt)
      }
      $ != null && m
        ? St($, a && a.ref, x, f || a, !f)
        : $ == null && a && a.ref != null && St(a.ref, null, x, a, !0)
    },
    ie = (a, f, p, _) => {
    ...
    ee = (a, f, p, _, m, x, w, v, y) => {
      if (
        ...
        try {
          ;(b && b._beginPatch(), Ht(a, f, m, x, w, v, y))
        } finally {
          b && b._endPatch()
        }
      }
    ...
    Le = (a, f, p, _, m, x, w, v) => {
      let y, b
      const { props: $, shapeFlag: k, transition: T, dirs: M } = a
      if (
        ((y = a.el = l(a.type, x, $ && $.is, $)),
        k & 8
          ? u(y, a.children)
          : k & 16 && Ne(a.children, y, null, _, m, vs(a, x), w, v),
        M && Ze(a, null, _, 'created'),
        ve(y, a, a.scopeId, w, _),
        $)
      ) {
        for (const K in $) K !== 'value' && !vt(K) && i(y, K, null, $[K], x, _)
        ;('value' in $ && i(y, 'value', null, $.value, x),
          (b = $.onVnodeBeforeMount) && Te(b, _, a))
      }
      M && Ze(a, null, _, 'beforeMount')
      const H = El(m, T)
      ;(H && T.beforeEnter(y),
        n(y, f, p),
        ((b = $ && $.onVnodeMounted) || H || M) &&
          he(() => {
            ;(b && Te(b, _, a), H && T.enter(y), M && Ze(a, null, _, 'mounted'))
          }, m))
    },
    ve = (a, f, p, _, m) => {
      if ((p && C(a, p), _)) for (let x = 0; x < _.length; x++) C(a, _[x])
      if (m) {
        let x = m.subTree
        if (f === x || (Fr(x.type) && (x.ssContent === f || x.ssFallback === f))) {
          const w = m.vnode
          ve(a, w, w.scopeId, w.slotScopeIds, m.parent)
        }
      }
    },
    Ne = (a, f, p, _, m, x, w, v, y = 0) => {
      for (let b = y; b < a.length; b++) {
        const $ = (a[b] = v ? Ue(a[b]) : $e(a[b]))
        F(null, $, f, p, _, m, x, w, v)
      }
    },
    Ht = (a, f, p, _, m, x, w) => {
      const v = (f.el = a.el)
      ...
      if (
        (p && Xe(p, !1),
        (M = T.onVnodeBeforeUpdate) && Te(M, p, f, a),
        $ && Ze(f, a, p, 'beforeUpdate'),
        p && Xe(p, !0),
        ((k.innerHTML && T.innerHTML == null) ||
          (k.textContent && T.textContent == null)) &&
          u(v, ''),
        b
          ? ze(a.dynamicChildren, b, v, p, _, vs(f, m), x)
          : w || W(a, f, v, null, p, _, vs(f, m), x, !1),
        y > 0)
      ) {
        if (y & 16) pt(v, k, T, p, m)
        else if (
          (y & 2 && k.class !== T.class && i(v, 'class', null, T.class, m),
          y & 4 && i(v, 'style', k.style, T.style, m),
          y & 8)
        ) {
          ...
          for (let K = 0; K < H.length; K++) {
            const V = H[K],
              fe = k[V],
              ue = T[V]
            ;(ue !== fe || V === 'value') && i(v, V, fe, ue, m, p)
          }
        }
        y & 1 && a.children !== f.children && u(v, f.children)
      } else !w && b == null && pt(v, k, T, p, m)
      ;((M = T.onVnodeUpdated) || $) &&
        he(() => {
          ;(M && Te(M, p, f, a), $ && Ze(f, a, p, 'updated'))
        }, _)
    },
    ze = (a, f, p, _, m, x, w) => {
      for (let v = 0; v < f.length; v++) {
        const y = a[v],
          b = f[v],
          $ = y.el && (y.type === Y || !bt(y, b) || y.shapeFlag & 198) ? g(y.el) : p
        F(y, b, $, null, _, m, x, w, !0)
      }
    },
    pt = (a, f, p, _, m) => {
      if (f !== p) {
        if (f !== U) for (const x in f) !vt(x) && !(x in p) && i(a, x, f[x], null, m, _)
        for (const x in p) {
          if (vt(x)) continue
          const w = p[x],
            v = f[x]
          w !== v && x !== 'value' && i(a, x, v, w, m, _)
        }
    ...
    Ft = (a, f, p, _, m, x, w, v, y) => {
      const b = (f.el = a ? a.el : o('')),
        $ = (f.anchor = a ? a.anchor : o(''))
      let { patchFlag: k, dynamicChildren: T, slotScopeIds: M } = f
      ;(M && (v = v ? v.concat(M) : M),
        a == null
          ? (n(b, p, _), n($, p, _), Ne(f.children || [], p, $, m, x, w, v, y))
          : k > 0 &&
              k & 64 &&
              T &&
              a.dynamicChildren &&
              a.dynamicChildren.length === T.length
            ? (ze(a.dynamicChildren, T, p, m, x, w, v),
    ...
    Dt = (a, f, p, _, m, x, w, v, y) => {
      ;((f.slotScopeIds = v),
        a == null
          ? f.shapeFlag & 512
            ? m.ctx.activate(f, p, _, w, y)
            : us(f, p, _, m, x, w, y)
          : rn(a, f, y))
    },
    us = (a, f, p, _, m, x, w) => {
      const v = (a.component = Nl(a, _, m))
      if ((_r(a) && (v.ctx.renderer = gt), Vl(v, !1, w), v.asyncDep)) {
        if ((m && m.registerDep(v, le, w), !a.el)) {
          const y = (v.subTree = te(Je))
          ;(D(null, y, f, p), (a.placeholder = y.el))
        }
      } else le(v, a, f, p, m, x, w)
    },
    rn = (a, f, p) => {
    ...
    le = (a, f, p, _, m, x, w) => {
      const v = () => {
        if (a.isMounted) {
          let { next: k, bu: T, u: M, parent: H, vnode: K } = a
          {
            const Se = Rr(a)
            if (Se) {
              ;(k && ((k.el = K.el), z(a, k, w)),
          ...
          let V = k,
            fe
          ;(Xe(a, !1),
            k ? ((k.el = K.el), z(a, k, w)) : (k = K),
            T && hs(T),
            (fe = k.props && k.props.onVnodeBeforeUpdate) && Te(fe, H, k, K),
            Xe(a, !0))
          const ue = yn(a),
            ke = a.subTree
          ;((a.subTree = ue),
            F(ke, ue, g(ke.el), Nt(ke), a, m, x),
            (k.el = ue.el),
            V === null && vl(a, ue.el),
            M && he(M, m),
            (fe = k.props && k.props.onVnodeUpdated) && he(() => Te(fe, H, k, K), m))
        } else {
          let k
          const { el: T, props: M } = f,
            { bm: H, m: K, parent: V, root: fe, type: ue } = a,
            ke = Ct(f)
          ;(Xe(a, !1),
            H && hs(H),
            !ke && (k = M && M.onVnodeBeforeMount) && Te(k, V, f),
            Xe(a, !0))
          {
            fe.ce && fe.ce._def.shadowRoot !== !1 && fe.ce._injectChildStyle(ue)
            const Se = (a.subTree = yn(a))
            ;(F(null, Se, p, _, a, m, x), (f.el = Se.el))
          }
          if ((K && he(K, m), !ke && (k = M && M.onVnodeMounted))) {
            const Se = f
            he(() => Te(k, V, Se), m)
          }
      ...
      a.scope.on()
      const y = (a.effect = new zn(v))
      a.scope.off()
      const b = (a.update = y.run.bind(y)),
        $ = (a.job = y.runIfDirty.bind(y))
      ;(($.i = a), ($.id = a.uid), (y.scheduler = () => Xs($)), Xe(a, !0), b())
    },
    z = (a, f, p) => {
      f.component = a
    ...
    W = (a, f, p, _, m, x, w, v, y = !1) => {
      ...
      if (T > 0) {
        if (T & 128) {
          Lt(b, k, p, _, m, x, w, v, y)
          return
        } else if (T & 256) {
          Qe(b, k, p, _, m, x, w, v, y)
          return
        }
      }
      M & 8
        ? ($ & 16 && ht(b, m, x), k !== b && u(p, k))
        : $ & 16
          ? M & 16
            ? Lt(b, k, p, _, m, x, w, v, y)
            : ht(b, m, x, !0)
          : ($ & 8 && u(p, ''), M & 16 && Ne(k, p, _, m, x, w, v, y))
    },
    Qe = (a, f, p, _, m, x, w, v, y) => {
      ;((a = a || lt), (f = f || lt))
      const b = a.length,
        $ = f.length,
        k = Math.min(b, $)
      let T
      for (T = 0; T < k; T++) {
        const M = (f[T] = y ? Ue(f[T]) : $e(f[T]))
        F(a[T], M, p, null, m, x, w, v, y)
      }
      b > $ ? ht(a, m, x, !0, !1, k) : Ne(f, p, _, m, x, w, v, y, k)
    },
    Lt = (a, f, p, _, m, x, w, v, y) => {
      let b = 0
      const $ = f.length
      let k = a.length - 1,
        T = $ - 1
      for (; b <= k && b <= T; ) {
        const M = a[b],
          H = (f[b] = y ? Ue(f[b]) : $e(f[b]))
        if (bt(M, H)) F(M, H, p, null, m, x, w, v, y)
        else break
        b++
      }
      for (; b <= k && b <= T; ) {
        const M = a[k],
          H = (f[T] = y ? Ue(f[T]) : $e(f[T]))
        if (bt(M, H)) F(M, H, p, null, m, x, w, v, y)
        else break
        ;(k--, T--)
      }
      if (b > k) {
        if (b <= T) {
          const M = T + 1,
            H = M < $ ? f[M].el : _
          for (; b <= T; )
            (F(null, (f[b] = y ? Ue(f[b]) : $e(f[b])), p, H, m, x, w, v, y), b++)
        }
      } else if (b > T) for (; b <= k; ) (we(a[b], m, x, !0), b++)
      else {
        const M = b,
          H = b,
          K = new Map()
        for (b = H; b <= T; b++) {
          const pe = (f[b] = y ? Ue(f[b]) : $e(f[b]))
        ...
        for (b = M; b <= k; b++) {
          ...
          Ce === void 0
            ...
            : ((mt[Ce - H] = b + 1),
              Ce >= Se ? (Se = Ce) : (ke = !0),
              F(pe, f[Ce], p, null, m, x, w, v, y),
              fe++)
        }
        const an = ke ? Ml(mt) : lt
        for (V = an.length - 1, b = ue - 1; b >= 0; b--) {
          const pe = H + b,
            Ce = f[pe],
            cn = f[pe + 1],
            fn = pe + 1 < $ ? cn.el || Hr(cn) : _
          mt[b] === 0
            ? F(null, Ce, p, fn, m, x, w, v, y)
            : ke && (V < 0 || b !== an[V] ? Ye(Ce, p, fn, 2) : V--)
        }
      }
    },
    Ye = (a, f, p, _, m = null) => {
      const { el: x, type: w, transition: v, children: y, shapeFlag: b } = a
      if (b & 6) {
      ...
      if (w === Y) {
        n(x, f, p)
        for (let k = 0; k < y.length; k++) Ye(y[k], f, p, _)
        n(a.anchor, f, p)
        return
      }
      if (w === ws) {
      ...
      if (_ !== 2 && b & 1 && v)
        if (_ === 0) (v.beforeEnter(x), n(x, f, p), he(() => v.enter(x), m))
        else {
          const { leave: k, delayLeave: T, afterLeave: M } = v,
            H = () => {
    ...
    we = (a, f, p, _ = !1, m = !1) => {
      ...
      const H = $ & 1 && T,
        K = !Ct(a)
      let V
      if ((K && (V = w && w.onVnodeBeforeUnmount) && Te(V, f, a), $ & 6))
        Gr(a.component, p, _)
      else {
        if ($ & 128) {
        ...
        ;(H && Ze(a, null, f, 'beforeUnmount'),
          $ & 64
            ? a.type.remove(a, f, p, gt, _)
            : b && !b.hasOnce && (x !== Y || (k > 0 && k & 64))
              ? ht(b, f, p, !1, !0)
              : ((x === Y && k & 384) || (!m && $ & 16)) && ht(y, f, p),
          _ && ln(a))
      }
      ;((K && (V = w && w.onVnodeUnmounted)) || H) &&
        he(() => {
          ;(V && Te(V, f, a), H && Ze(a, null, f, 'unmounted'))
        }, p)
    },
    ln = (a) => {
    ...
    Gr = (a, f, p) => {
      const { bum: _, scope: m, job: x, subTree: w, um: v, m: y, a: b } = a
      ;(kn(y),
        kn(b),
        _ && hs(_),
        m.stop(),
  ...
  const on = (a, f, p) => {
    ...
    gt = { p: F, um: we, m: Ye, r: ln, mt: us, mc: Ne, pc: W, pbc: ze, n: Nt, o: e }
...
let It = 1
function Sn(e, t = !1) {
  ;((It += e), e < 0 && me && t && (me.hasOnce = !0))
}
function Dr(e) {
  return (
    (e.dynamicChildren = It > 0 ? me || lt : null),
    Ol(),
    It > 0 && me && me.push(e),
    e
  )
...
function P(e, t, s, n, r, i) {
  return Dr(d(e, t, s, n, r, i, !0))
}
function Lr(e, t, s, n, r) {
  return Dr(te(e, t, s, n, r, !0))
}
function Nr(e) {
...
const Br = ({ key: e }) => e ?? null,
  Kt = ({ ref: e, ref_key: t, ref_for: s }) => (
    typeof e == 'number' && (e = '' + e),
    e != null ? (X(e) || ne(e) || O(e) ? { i: xe, r: e, k: t, f: !!s } : e) : null
  )
function d(e, t = null, s = null, n = 0, r = null, i = e === Y ? 0 : 1, l = !1, o = !1) {
  ...
  return (
    o ? (nn(c, s), i & 128 && e.normalize(c)) : s && (c.shapeFlag |= X(s) ? 8 : 16),
    It > 0 && !l && me && (c.patchFlag > 0 || i & 6) && c.patchFlag !== 32 && me.push(c),
    c
  )
}
const te = jl
function jl(e, t = null, s = null, n = 0, r = null, i = !1) {
  if (((!e || e === ll) && (e = Je), Nr(e))) {
    ...
    return (
      s && nn(o, s),
      It > 0 && !i && me && (o.shapeFlag & 6 ? (me[me.indexOf(e)] = o) : me.push(o)),
      (o.patchFlag = -2),
      o
    )
  }
  if ((ql(e) && (e = e.__vccOpts), t)) {
    ...
    ;(o && !X(o) && (t.class = rs(o)),
      G(c) && (Zs(c) && !I(c) && (c = re({}, c)), (t.style = Ws(c))))
  }
  const l = X(e) ? 1 : Fr(e) ? 128 : qi(e) ? 64 : G(e) ? 4 : O(e) ? 2 : 0
  return d(e, t, s, n, r, l, i, !0)
}
function Rl(e) {
  return e ? (Zs(e) || $r(e) ? re({}, e) : e) : null
}
function ut(e, t, s = !1, n = !1) {
  const { props: r, ref: i, patchFlag: l, children: o, transition: c } = e,
    ...
    u = {
      ...
      props: h,
      key: h && Br(h),
      ref: t && t.ref ? (s && i ? (I(i) ? i.concat(Kt(t)) : [i, Kt(t)]) : Kt(t)) : i,
      scopeId: e.scopeId,
...
function dt(e = '', t = !1) {
  return t ? (A(), Lr(Je, null, e)) : te(Je, null, e)
}
function $e(e) {
...
function nn(e, t) {
  ...
  if (t == null) t = null
    ...
    O(t)
      ...
      : ((t = String(t)), n & 64 ? ((s = 16), (t = [Hl(t)])) : (s = 8))
...
let Zt, Rs
{
  ...
  ;((Zt = t('__VUE_INSTANCE_SETTERS__', (s) => (ce = s))),
...
const Xt = Symbol('_vod'),
  Kr = Symbol('_vsh'),
  Xl = {
    name: 'show',
    beforeMount(e, { value: t }, { transition: s }) {
      ;((e[Xt] = e.style.display === 'none' ? '' : e.style.display),
...
function _t(e, t) {
  ;((e.style.display = t ? e[Xt] : 'none'), (e[Kr] = !t))
}
const eo = Symbol(''),
  to = /(?:^|;)\s*display\s*:/
function so(e, t, s) {
  ...
  Xt in e && ((e[Xt] = i ? n.display : ''), e[Kr] && (n.display = 'none'))
}
const Pn = /\s*!important$/
function qt(e, t, s) {
  if (I(s)) s.forEach((n) => qt(e, t, n))
...
function ho(e, t, s, n) {
  if (n) return !!(t === 'innerHTML' || t === 'textContent' || (t in e && Hn(t) && O(s)))
  if (
    t === 'spellcheck' ||
    t === 'draggable' ||
    t === 'translate' ||
...
const Ls = (e) => {
  ...
  qr = () => {
    ...
    ;(($t.value = t),
      ...
      (Ds = !0),
      (Dn = (s) => {
        window.localStorage.getItem(Fs) || (($t.value = s.matches), Ls(s.matches))
      }),
      Cs.addEventListener('change', Dn))
  }
function yo() {
  !Ds && typeof window < 'u' && qr()
  const e = (s) => {
    if (typeof window > 'u') return
    const n = !!s
    ;(($t.value = n), window.localStorage.setItem(Fs, n ? 'dark' : 'light'), Ls(n))
  }
...
const Q = {
  ...
  Mo = { class: 'flex items-center gap-3 md:hidden' },
  Io = ['aria-label', 'aria-pressed'],
      ...
      return (h, u) => (
        ...
        P('header', vo, [
          d('nav', wo, [
            d('div', ko, [
              d('a', So, [
                d('span', Co, j(L(Q).name), 1),
                d('span', null, j(L(Q).role), 1),
              ]),
              d('div', To, [
                (A(),
                P(
  ...
  Bo = {
    id: 'hero',
    class:
      'rounded-3xl border border-slate-200/60 bg-white/65 px-6 py-6 shadow-lg shadow-slate-200/40 sm:px-8 sm:py-10 dark:border-slate-800/60 dark:bg-slate-900/30 dark:shadow-none',
  },
  Vo = { class: 'grid gap-10 sm:gap-12 lg:grid-cols-[1.2fr,0.8fr]' },
  Uo = { class: 'order-2 space-y-8 text-pretty lg:order-1' },
  Wo = {
    key: 0,
    class:
  ...
  Yo = {
    class:
      'order-1 relative mx-auto aspect-square w-full max-w-[320px] overflow-hidden rounded-full text-white shadow-card sm:max-w-[360px] lg:order-2 lg:max-w-[420px]',
  },
  Zo = { class: 'absolute inset-0' },
  Xo = ['src', 'alt'],
  ea = {
    key: 1,
  ...
  ta = {
    __name: 'Hero',
    setup(e) {
      const t = Ke(() => Q.heroImage?.src ?? ''),
        s = Ke(() => Q.heroImage?.alt ?? `${Q.name} workspace placeholder`),
        n = Ke(() => !!t.value)
      return (r, i) => (
        A(),
        P('section', Bo, [
          d('div', Vo, [
            d('div', Uo, [
              L(Q).availabilityTag
                ? (A(), P('p', Wo, j(L(Q).availabilityTag), 1))
                : dt('', !0),
              d('div', Ko, [
                d('h1', qo, ' Hi, I’m ' + j(L(Q).nickname) + '. ', 1),
                d('p', Jo, j(L(Q).intro), 1),
              ]),
              i[0] ||
                (i[0] = d(
                  'div',
                  ...
                  ge(
                    ...
                    (l) => (
                      ...
                      P(
                        ...
                        [d('dt', zo, j(l.label), 1), d('dd', Qo, j(l.value), 1)]
                      )
                    )
                  ),
                  128
  ...
  sa = { id: 'about', class: 'space-y-0' },
  na = { class: 'grid gap-8 lg:grid-cols-[0.5fr,1fr] lg:gap-10' },
  ra = {
    class:
  ...
  ia = { class: 'text-sm text-slate-500 dark:text-slate-400' },
  la = {
    class:
      'space-y-6 text-base leading-relaxed text-slate-600 sm:space-y-8 dark:text-slate-300',
  },
  oa = { class: 'mt-6 border-t border-slate-200/70 pt-6 dark:border-slate-800' },
  aa = { class: 'mt-4 flex flex-wrap gap-3' },
  ca = {
    __name: 'About',
    setup(e) {
      return (t, s) => (
        ...
        P('section', sa, [
          d('div', na, [
            d('div', ra, [
              ...
              d('p', ia, j(L(Q).location) + ' · ' + j(L(Q).availability), 1),
            ]),
            d('div', la, [
              d('p', null, j(L(Q).summary), 1),
              d('p', null, j(L(Q).secondarySummary), 1),
              d('div', oa, [
                s[2] ||
                  (s[2] = d(
                    'p',
  ...
  ua = {
    id: 'skills',
    class:
      'space-y-8 rounded-3xl border border-slate-200/70 bg-white/60 px-6 py-6 sm:px-8 sm:py-8 md:px-10 md:py-10 dark:border-slate-800/70 dark:bg-slate-900/40',
  },
  da = { class: 'grid gap-5 md:grid-cols-2 xl:grid-cols-3' },
  pa = { class: 'text-xl font-semibold text-slate-900 dark:text-white' },
  ha = { class: 'mt-3 text-sm text-slate-500 dark:text-slate-400' },
  ga = { class: 'mt-5 flex flex-wrap gap-2' },
  ma = {
    __name: 'Skills',
    setup(e) {
      return (t, s) => (
  ...
  va = { class: 'space-y-3 text-pretty' },
  wa = { class: 'text-2xl font-semibold text-slate-900 dark:text-white' },
  ka = {
    class:
  ...
  $a = { class: 'mt-2 leading-relaxed' },
  Pa = { class: 'flex flex-col gap-3 sm:flex-row' },
  Ea = ['href'],
  Ma = ['href'],
  Ia = { class: 'lg:w-[42%] space-y-4' },
  Oa = {
    class:
  ...
  ja = ['src', 'alt'],
  Ra = { class: 'mt-3 flex flex-wrap gap-2' },
  Ha = {
    __name: 'ProjectCard',
    props: {
        ...
        P('article', xa, [
          d(
            ...
            [
              d('div', ba, [
                d('div', _a, [
                  d('span', ya, j(r.value), 1),
                  l[0] || (l[0] = d('span', null, 'Case Study', -1)),
                ]),
                d('div', va, [d('h3', wa, j(e.project.title), 1)]),
                d('div', ka, [
                  d('div', null, [
                    l[1] ||
                      (l[1] = d(
  ...
  Da = { id: 'projects', class: 'space-y-10' },
  La = { class: 'space-y-8' },
  Na = {
    __name: 'Projects',
    setup(e) {
          ...
          d('div', La, [
            ...
            P(
              ...
              ge(
                ...
                (n, r) => (
                  A(),
                  Lr(Ha, { key: n.title, project: n, index: r }, null, 8, [
                    'project',
                    'index',
                  ])
                )
  ...
  Va = { id: 'experience', class: 'space-y-10' },
  Ua = { class: 'relative space-y-10' },
  Wa = { class: 'flex flex-col gap-4 md:flex-row md:items-center md:justify-between' },
  Ka = { class: 'mt-2 text-2xl font-semibold text-slate-900 dark:text-white' },
  ...
  za = { class: 'flex flex-wrap items-center justify-between gap-3' },
  Qa = { class: 'text-xl font-semibold text-slate-900 dark:text-white' },
  Ya = {
    class:
  ...
  ec = { class: 'mt-3 flex flex-wrap gap-2' },
  tc = {
          ...
          d('div', Ua, [
            s[5] ||
              (s[5] = d(
                ...
                {
                  class:
                    'pointer-events-none absolute left-8 top-0 hidden h-full w-px -translate-x-1/2 bg-slate-200 md:block dark:bg-slate-800',
                },
                null,
                -1
              )),
                ...
                (n) => (
                  ...
                  P(
                    'article',
                    {
                      key: n.company,
                      class:
                        'relative rounded-3xl border border-slate-200/80 bg-white/90 p-6 shadow-card transition-all md:pl-16 dark:border-slate-800/80 dark:bg-slate-900/70',
                    },
                    [
                      s[4] ||
                        (s[4] = d(
                          ...
                          {
                            class:
                              'pointer-events-none absolute left-8 top-8 hidden h-4 w-4 -translate-x-1/2 rounded-full border-4 border-white bg-brand-500 shadow-[0_0_0_8px_rgba(14,165,233,0.2)] md:block dark:border-slate-900',
                          },
                          null,
                          -1
                        )),
                              ...
                              P(
                                ...
                                [
                                  d('div', za, [
                                    ...
                                    d('span', Ya, j(r.period || n.period), 1),
                                  ]),
                                  d('ul', Za, [
                                    (A(!0),
                                    P(
  ...
  sc = { id: 'download', class: 'px-4 py-10 text-center sm:px-6 md:px-8' },
  nc = {
    __name: 'DownloadCV',
    setup(e) {
      return (t, s) => (
  ...
  rc = { id: 'contact' },
  ic = { class: 'grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-[0.9fr,1.1fr]' },
  lc = { class: 'space-y-6 text-pretty' },
  oc = { class: 'text-base text-slate-600 text-pretty sm:text-lg dark:text-slate-300' },
  ac = { key: 0 },
  cc = { class: 'mt-2 text-base text-slate-800 sm:text-lg dark:text-slate-200' },
  fc = { class: 'mt-2 text-base text-slate-800 sm:text-lg dark:text-slate-200' },
  uc = {
    class:
  ...
  dc = { class: 'space-y-4' },
  pc = { class: 'mt-3 flex flex-wrap gap-2' },
  hc = ['href'],
  gc = { class: 'flex items-center justify-center gap-2 whitespace-nowrap' },
  mc = { class: 'text-slate-500 dark:text-slate-400', 'aria-hidden': 'true' },
  xc = { key: 0, class: 'h-4 w-4', viewBox: '0 0 24 24', fill: 'currentColor' },
  bc = { key: 1, class: 'h-4 w-4', viewBox: '0 0 24 24', fill: 'currentColor' },
  _c = { key: 2, class: 'h-4 w-4', viewBox: '0 0 24 24', fill: 'currentColor' },
  yc = {
    __name: 'Contact',
    setup(e) {
      const t = `mailto:${Q.contact.email}`
      return (s, n) => (
        A(),
        P('section', rc, [
          d('div', ic, [
            d('div', lc, [
              ...
              d('p', oc, j(L(Q).contact.note), 1),
              L(Q).contact.availability
                ? (A(),
                  P('div', ac, [
                    n[0] ||
                      (n[0] = d(
                    ...
                    d('p', cc, j(L(Q).contact.availability), 1),
                  ]))
                : dt('', !0),
              d('div', null, [
                n[1] ||
                ...
                d('p', fc, j(L(Q).contact.location), 1),
              ]),
            ]),
            d('div', uc, [
              d('div', dc, [
  ...
  Sc = { class: 'min-h-screen text-slate-900 dark:text-slate-100' },
  Cc = {
    class:
  ...
  Tc = {
    ...
    setup(e) {
      return (t, s) => (
        ...
        P('div', Sc, [
          te(No),
          d('main', Cc, [te(ta), te(ca), te(ma), te(Na), te(tc), te(yc), te(nc)]),
          te(kc),
        ])
      )
    },
